...
class Tests(object):
    def test_check_commit_fwd(self):
        ...
        assert utilities.check_commit('atesa_v2/tests/test_data/test.rst7', settings) == 'fwd'
    ...
    def test_check_commit_bwd(self):
        ...
        assert utilities.check_commit('atesa_v2/tests/test_data/test.rst7', settings) == 'bwd'
    ...
    def test_check_commit_none(self):
        ...
        settings.commit_bwd = [[1, 2], [3, 4], [0.5, 2.0], ['lt', 'gt']]
        assert utilities.check_commit('atesa_v2/tests/test_data/test.rst7', settings) == ''
    ...
    def test_check_commit_value_errors(self):
        ...
        with pytest.raises(ValueError):
            utilities.check_commit('atesa_v2/tests/test_data/test.rst7', settings)
        settings.commit_fwd = [[1, 2], [3, 4], [1.0, 1.5], ['gt', 'lt']]
    ...
    def test_get_cvs_no_qdot(self):
        ...
        result = utilities.get_cvs('atesa_v2/tests/test_data/test.rst7', settings)
    ...
    def test_get_cvs_with_qdot(self):
        ...
        settings.topology = 'atesa_v2/tests/test_data/test.prmtop'
        settings.cvs = ['pytraj.distance(traj, \'@1 @3\')[0]', 'pytraj.distance(traj, \'@2 @4\')[0]']
        result = utilities.get_cvs('atesa_v2/tests/test_data/test_velocities.rst7', settings)
